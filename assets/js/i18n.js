    ...
    const TRANSLATIONS_DATA = {
        ...
        ar: {
            ...
            "pillars": {
                ...
                "intro": "من خلال إطار عمل ELM الثلاثي لكيما، ستطور الحضور التنفيذي، وتتقن القيادة التكيفية، وتزرع عقلة ريادية موجهة نحو الفرص، مما يعزز القدرات المهنية المطلوبة للتنفيذ بدقة وتأثير.",
            ...
            "leadership_levels": {
                ...
                "level1_label": "ELM1",
                "level1_title": "مختص تجاري إلى تنفيذي",
                "level1_subtitle": "التحول من كونك خبيرًا في المادة إلى قيادة مبادرات تنظيمية استراتيجية.",
                "level1_desc": "الانتقال من كونك خبيرًا في الموضوع إلى قيادة مبادرات تنظيمية استراتيجية.",
                "level1_focus_title": "مجالات التركيز الرئيسية",
                "level1_focus1": "تطوير التفكير الاستراتيجي والرؤية",
                "level1_focus2": "تعلم تفويض العمل الفني",
                "level1_focus3": "بناء علاقات متعددة الوظائف",
                "level1_focus4": "التركيز على التأثير التنظيمي",
                "level1_focus5": "إرشاد المواهب الناشئة في مجالك",
                "level1_focus6": "Mentor emerging talent in your field",
                "level2_label": "ELM2",
                "level2_title": "مدير بدرج בינוני إلى مستوى C",
                "level2_subtitle": "الانتقال من إدارة الفرق إلى القيادة على مستوى المؤسسة واتخاذ القرارات الاستراتيجية.",
                "level2_desc": "الانتقال من إدارة الفرق إلى القيادة على مستوى المؤسسة واتخاذ القرارات الاستراتيجية.",
                "level2_focus1": "إتقان التخطيط الاستراتيجي على مستوى المؤسسة",
                "level2_focus2": "تطوير مهارات التواصل على مستوى C",
                ...
                "level3_label": "ELM3",
                "level3_title": "From C-Level to CEO",
                "level3_subtitle": "Advance to ultimate organizational responsibility and vision setting.",
                "level3_desc": "Advance to ultimate organizational responsibility and vision setting.",
                "level3_focus1": "Define organizational vision and culture",
                "level3_focus2": "Master board-level communication",
                ...
                "level3_focus5": "Navigate market transformation",
                "level4_label": "ELM4",
                "level4_title": "From Leader to Founder",
                "level4_subtitle": "Transition from leading to creating",
                "level4_desc": "Transition from leading to creating, scaling your vision through others.",
                "level4_focus1": "Build scalable leadership systems",
                "level4_focus2": "Delegate operational responsibilities",
                "level4_focus3": "Develop strategic partnerships",
                "level4_focus4": "Create sustainable growth frameworks",
        ...
        he: {
            ...
            "hero": {
                "headline": "הוב��ל בהשפעה",
                "headline_accent": "בנה בהשפעה",
                "description": "גשר על פער ניסיון המנהיגות המנהלתית שלך כדי להרחיב את ההשפעה שלך ולהאיץ את הצמיחה שלך. הפוך לעמית קימא וקבל הסמכת בניהול מנהיגות יזמית ברמת ההשפעה בעולם האמיתי.",
                "cta_enroll": "הירשם",
                "cta_contact": "צור קשר"
            },
            "philosophy": {
                "quote": "מנהיגים גדולים לומדים מניסיון. מנהיגים יוצאי דופן מאחרים",
            ...
            "pillars": {
                ...
                "pillar1_title": "מנהיגות מודעת",
                "pillar1_desc": "Leadership isn't inherited. It's built. Master frameworks and transition from manager to conscious leader.",
                "pillar2_title": "יזמות מונחית ערך",
                "pillar2_desc": "יזמות היא מצב רוח של יצירת ערך. Develop opportunity recognition and drive innovation in any context.",
                "pillar3_title": "ניהול מקצועי",
                "pillar3_desc": "رؤיتك לא שווה כלום אם אתה לא יכול לתקשר אותה. שכלל סיפור, שכנוע ונוכחות מנהלתית.",
                "learn_more": "למד עוד"
            },
            "outcomes": {
            ...
            "leadership_levels": {
                ...
                "level1_label": "ELM1",
                "level1_title": "Mختص תجاري למנהל",
                "level1_subtitle": "עבור מלהיות מומחה נושא להובלת יוזמות ארגוניות אסטרטגיות.",
                "level1_desc": "עבור מלהיות מומחה נושא להובלת יוזמות ארגוניות אסטרטגיות.",
                "level1_focus_title": "תחומי מיקוד מרכזיים",
                "level1_focus1": "הובלה ללא סמכות רשמית",
                "level1_focus2": "פיתוח חשיבה אסטרטגית וחזון",
                "level1_focus3": "למד להאציל עבודה טכנית",
                "level1_focus4": "בניית קשרים בין-תפקודיים",
                "level1_focus5": "התמקדות בהשפעה ארגונית",
                "level1_focus6": "Mentor emerging talent in your field",
                "level2_label": "ELM2",
                "level2_title": "מנהל ברמה בינונית ל-C-Level",
                "level2_subtitle": "עבור מניהול צוותים לقيادة ארגונית רחבה וקבלת החלטות אסטרטגית.",
                "level2_desc": "עבור מניהול צוותים לقيادة ארגונית רחבה וקבלת החלטות אסטרטגית.",
                "level2_focus1": "שליטה בתכנון אסטרטגי ארגוני",
                "level2_focus2": "פיתוח כישורי תקשורת ברמת C",
                "level2_focus3": "בניית נוכחות והשפעה מנהלתית",
                "level2_focus4": "הובלת טרנספורמציה ארגונית",
                ...
                "level3_focus3": "הנעת צמיחה אסטרטגית ארוכת טווח",
                "level3_focus4": "בניית צוותי הנהלה בעלי ביצועים��",
                "level3_focus5": "ניווט בשינויי שוק",
                "level4_label": "ELM4",
                "level4_title": "From Leader to Founder",
                "level4_subtitle": "Transition from leading to creating",
                "level4_desc": "Transition from leading to creating, scaling your vision through others.",
                ...
                "level4_focus4": "יצירת מסגרות צמיחה בת-קיימא",
                "level4_focus5": "הדרכה והעצמת מנהיגי צוותים",
                "level5_label": "ELM5",
                "level5_title": "הופך למנהיג",
                "level5_subtitle": "התכונן לצעוד לניהול על ידי בניית מערכת ההפעלה הפנימית של מנהיגות, לפני שהתואר מגיע.",
                "level5_desc": "התכונן לצעוד לניהול על ידי בניית מערכת ההפעלה הפנימית של מנהיגות, לפני שהתואר מגיע.",
                "level5_focus_title": "תחומי מיקוד מרכזיים",
                "level5_focus1": "Develop leadership presence and personal credibility",
                "level5_focus2": "Make structured decisions in uncertain environments",
                "level5_focus3": "Influence across teams without formal authority",
                "level5_focus4": "Translate strategy into team-level execution",
                ...
                "level6_desc": "התחבר לרשת המאיצים והשותפים האסטרטגיים שלנו כדי להגביר את מסע המנהיגות שלך.",
            ...
            "register_elm": {
                ...
                "investment_desc": "הכשרה מקיפה כוללת את כל המפגשים החיצוניים, הדרכה אישית וمواد البرنامج",
                "outcome_label": "תוצאה",
                "outcome_text": "التقدم إلى مستوى מנהיגות מנהלתית, מצויד לבניית והרחבת מיזמים מצליחים",
            ...
            "modals": {
                ...
                "module1_intro": "liderה אינה תורשתית. היא נבנית.",
                "module1_desc": "המוסדות המובילים בעולם - הרווארד, MIT - הוכיחו שliderה היא מיומנות ניתנת ללמידה. אנו מביאים לך את המתודולוגיות המוכחות שלהם, מותאמות ליישום בעולם האמיתי.",
                "module1_what_title": "מה תשלוט:",
                "module1_point1": "מסגרות מנהיגות טכנית והסתגלותית",
                "module1_point2": "קבלת החלטות אי-וודאות וחמשת חוקי המנהיגות",
                ...
                "module3_point1": "סיפור והצגה משכנוע",
                ...
                "enrollment_title": "הרשמה לתוכנית ELM",
                "enrollment_intro": "שנה את מסע המנהיגות שלך.",
                "enrollment_desc": " מלא את הטופס למטה כדי להבטיח את מקומך בתוכנית ניהול המנהיגות היזמית.",
                "program_modal1_title": "Mختص תجاري למנהל",
                "program_modal1_subtitle": "التحول من التخصص إلى الإشراف التنفيذي",
                "program_modal1_benefit_title": "ما ستحصل عليه",
                "program_modal1_benefit1_title": "جلسات قيادية مكثفة",
                "program_modal1_benefit1_desc": "6 מפגשים עם השפעה גבוהה בהרצליה",
                "program_modal1_benefit2_title": "הדרכה אישית",
                "program_modal1_benefit2_desc": "8 הדרכות אישיות מעוצבות עבורך",
                "program_modal1_benefit3_title": "תעודת LEM",
                "program_modal1_benefit3_desc": "הצטרף לרשת המנהיגות KIMA LEM",
                ...
                "accelerators_modal_desc": "تواصل مع הרשת המאיצים והשותפים האסטרטגיים שלנו כדי להגביר את מסע המנהיגות שלך.",
                "accelerators_benefit_title": "יתרונות שותפות",
                "accelerators_benefit1_title": "גישה لنظمة",
                "accelerators_benefit1_desc": "התחברות עם מובילי תעשייה",
                "accelerators_benefit2_title": "فرص המימון",
                "accelerators_benefit2_desc": "הوصول إلى رأس المال ומשקיעים",
